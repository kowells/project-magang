...
$checkQuery = "SELECT COUNT(*) as count FROM jlc WHERE tanggal = '$tanggal'";
...
if ($count > 0) {
    ...
    $updateQuery = "UPDATE jlc SET pelajarL='$pelajarL', pelajarP='$pelajarP', mhsL='$mhsL', mhsP='$mhsP', umumL='$umumL', umumP='$umumP' WHERE tanggal='$tanggal'";
