...
$checkQuery = "SELECT COUNT(*) as count FROM ruang_tandon WHERE tanggal = '$tanggal'";
...
if ($count > 0) {
    ...
    $updateQuery = "UPDATE ruang_tandon SET pelajarL='$pelajarL', pelajarP='$pelajarP', mhsL='$mhsL', mhsP='$mhsP', umumL='$umumL', umumP='$umumP' WHERE tanggal='$tanggal'";
